...
const HomeThreeBackground = () => {
    ...
    useEffect(() => {
        ...
        // Dark background like merchandise page
        renderer.setClearColor(0x0a0a0a, 1); // Same dark background as merchandise
        ...
        // Blue and white color palette for home page (only 2 colors)
        const colorPalette = [
            new THREE.Color(1.0, 1.0, 1.0),     // Pure white
            new THREE.Color(0.2, 0.6, 1.0),     // Blue
        ];

        // Create rotating star field - same as merchandise
        const starCount = 1500; // Same as merchandise
        ...
        for (let i = 0; i < starCount; i++) {
            // Same positioning as merchandise
            positions[i * 3] = (Math.random() - 0.5) * 500;
            positions[i * 3 + 1] = (Math.random() - 0.5) * 500;
            positions[i * 3 + 2] = (Math.random() - 0.5) * 500;

            // Random colors (white and blue only)
            const color = colorPalette[Math.floor(Math.random() * colorPalette.length)];
            colors[i * 3] = color.r;
            colors[i * 3 + 1] = color.g;
            colors[i * 3 + 2] = color.b;

            // Same sizes as merchandise
            sizes[i] = Math.random() * 4 + 2;

            // Random twinkle phases
            twinklePhases[i] = Math.random() * Math.PI * 2;

            // Same velocities as merchandise
            velocities.push({
        ...
        // Point material with circular texture and glow - same as merchandise
        ...
        // Add larger glowing particles - same as merchandise
        const glowCount = 200;
        ...
        // Animation loop - same as merchandise
        const animate = () => {
            animationIdRef.current = requestAnimationFrame(animate);

            const time = Date.now() * 0.001;

            // Animate main stars - same as merchandise
            ...
            for (let i = 0; i < starCount; i++) {
                // Enhanced twinkling effect with color-specific glow - same as merchandise
                ...
                // Fast movement with slight acceleration - same as merchandise
            ...
            // Animate glow particles - same as merchandise
            ...
            // Subtle camera movement - same as merchandise
